...
export default function DoctorCard({ doctor }: { doctor: IDoctor }) {
  ...
  return (
    <div>
      <Card key={doctor.id} className="w-full rounded-2xl border p-4 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              <Avatar className="h-12 w-12">
                <AvatarImage
                  ...
                  src={doctor?.profilePhoto || "https://github.com/shadcn.png"}
                />
          ...
          <div className="w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl dark:bg-zinc-900 max-h-[90vh] overflow-y-auto my-auto">
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Doctor Schedules</p>
              </div>
              ...
              {selectedDoctor.doctorSchedules?.length > 0 ? (
                selectedDoctor.doctorSchedules.map((scheduleItem) => (
                  ...
                  >
                    ...
                    >
                      {scheduleItem.isBooked ? "Booked" : "Available"}
                    </span>
                  </div>
                ))
              ) : (
