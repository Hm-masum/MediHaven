...
export default function DoctorProfile({ doctor }: { doctor: IDoctorProfile }) {
  return (
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        doctor.needPasswordChange ? "destructive" : "secondary"
                      }
                    >
                      {doctor.needPasswordChange ? "Required" : "No"}
                    </Badge>
                  </div>
                </CardContent>
              </Card>
