...
router.get("/me", (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.DOCTOR, client_1.UserRole.PATIENT, client_1.UserRole.SUPER_ADMIN), user_controller_1.userController.getMyProfile);
...
router.patch("/update-my-profile", (0, auth_1.default)(client_1.UserRole.ADMIN, client_1.UserRole.SUPER_ADMIN, client_1.UserRole.PATIENT, client_1.UserRole.DOCTOR), fileUploader_1.fileUploader.upload.single("file"), (req, res, next) => {
