...
const getAllSchedules = (filters, options, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const doctorSchedules = yield prisma_1.default.doctorSchedule.findMany({
        where: {
    ...
    const result = yield prisma_1.default.schedule.findMany({
        where: Object.assign(Object.assign({}, whereConditions), { id: { notIn: doctorScheduleIds } }),
        skip: skip,
        take: limit,
