...
const getAllPatients = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const updatePatientIntoDB = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updatedPatientInfo = yield prisma_1.default.patient.findUniqueOrThrow({
...
const deletePatient = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const patientDeletedData = yield transactionClient.patient.delete({
            where: { id },
        });
